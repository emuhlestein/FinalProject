 ...
 * on 2016-10-01 at 19:46:05 UTC 
 * Modify at your own risk.
 */

package com.intelliviz.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetJoke getJoke(java.lang.Integer index, java.lang.Integer type) throws java.io.IOException {
    GetJoke result = new GetJoke(index, type);
    initialize(result);
    return result;
  }

  public class GetJoke extends MyApiRequest<com.intelliviz.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "{index}/{type}";
     ...
     * @since 1.13
     */
    protected GetJoke(java.lang.Integer index, java.lang.Integer type) {
      super(MyApi.this, "GET", REST_PATH, null, com.intelliviz.backend.myApi.model.MyBean.class);
    ...
    public GetJoke setIndex(java.lang.Integer index) {
      this.index = index;
      return this;
    }
    ...
    public GetJoke setType(java.lang.Integer type) {
      this.type = type;
      return this;
    }
